...
from income_prediction.entity.income_prediction_predictor import income_prediction_Predictor, income_prediction_Data
...
def predict():
    ...
    if request.method == 'POST':
        ...
        income_prediction_data = income_prediction_Data(longitude=longitude,
                                   latitude=latitude,
        ...
        income_prediction_predictor = income_prediction_Predictor(model_dir=MODEL_DIR)
