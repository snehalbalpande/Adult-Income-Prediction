...
from income_prediction.entity.entity_config import DataValidationConfig
from income_prediction.entity.artifact_entity import DataIngestionArtifact,DataValidationArtifact
